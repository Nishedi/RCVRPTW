...
namespace RCVRPTW
{
    ...
    public static class RLParameterValidation
    {
        ...
        private static readonly string DEFAULT_TEST_INSTANCE = Path.Combine("pliki", "100 lokacji", "C101.txt");
        ...
        public static void RunValidation()
        {
            ...
            // Solution discarded - only testing warning functionality, not evaluating solution quality
