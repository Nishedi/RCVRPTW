...
To evaluate the effectiveness and robustness of the proposed approaches, we formulate the following research hypotheses:
...
\begin{itemize}
    ...
    \item[\textbf{H2.}] The Tabu Search exhibits smaller variability of results across scenarios. This indicates higher robustness, as the solution quality remains more stable when faced with changes in input data.
